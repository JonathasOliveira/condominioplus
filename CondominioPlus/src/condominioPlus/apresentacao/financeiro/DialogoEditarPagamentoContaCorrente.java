 ...
 */
public class DialogoEditarPagamentoContaCorrente extends javax.swing.JDialog {
    ...
    public DialogoEditarPagamentoContaCorrente(Pagamento pagamento) {
        initComponents();
...
//        tabela.getColumn(modeloTabela.getCampo(5)).setMinWidth(110);
    ...
    private List<Pagamento> getPagamentos() {
        List<Pagamento> lista = Main.getCondominio().getContaCorrente().getPagamentos();
    ...
    private void preencherTela() {
        txtData.setValue(DataUtil.getDate(pagamento.getDataPagamento()));
    ...
    private class ControladorEventos extends ControladorEventosGenerico {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == btnSalvar) {
                ...
                if (getPagamentos().get(0).getForma() == FormaPagamento.CHEQUE) {
                    ...
                    ApresentacaoUtil.exibirInformacao("Relatorio vai ser feito depois", DialogoEditarPagamentoContaCorrente.this);
                }
                ...
                if (new LimitarCaracteres(10).ValidaNumero(txtConta)) {
                    if (!txtConta.getText().equals("") && txtConta.getText() != null) {
                        ...
                        if (resultado != null) {
                            ...
                            ApresentacaoUtil.exibirErro("Código Inexistente!", DialogoEditarPagamentoContaCorrente.this);
                            txtConta.setText("");
                            txtConta.grabFocus();
                            return;
                        }
        ...
        public void configurar() {
            ApresentacaoUtil.adicionarListener(
                    ApresentacaoUtil.transferidorFocoEnter, DialogoEditarPagamentoContaCorrente.this, JTextField.class, JComboBox.class);
            ApresentacaoUtil.adicionarListener(ApresentacaoUtil.selecionadorTexto, DialogoEditarPagamentoContaCorrente.this, JTextField.class);
